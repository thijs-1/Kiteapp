...
Turns out weather forecasting agencies and climate modelling agencies open-source their data! To determine the kiteability of a spot I downloaded 10 years of hindcast weather analysis. The best weather and climate models fitted to actual observations to generate the most complete and accurate weather data possible across the globe. To be precise, I downloaded **10 years of ERA5 wind data** from the Copernicus Climate Data Store to identify optimal kitesurfing locations around the world.

Wind data (at 10 m above the earth's surface) is sourced from [ERA5](https://cds.climate.copernicus.eu/), the fifth generation ECMWF atmospheric reanalysis of global climate. ERA5 provides hourly estimates of atmospheric variables from 1940 to present.
...
## Limitations
The data is extracted from a grid that is 0.25 degrees, or roughly 28 km at the equator. This means that any geographical features and their effects on the wind which are smaller than that are not well represented. Small peninsula covered in trees upwind of you? That is not captured.
